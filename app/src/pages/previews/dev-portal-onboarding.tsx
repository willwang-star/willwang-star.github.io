      ...
      <div className="space-y-12">
        ...
        <Tabs defaultValue="problem" className="space-y-8">
          <TabsList pin>
            ...
            <TabsTrigger value="systemic">8 Core Problems</TabsTrigger>
            <TabsTrigger value="personas">Personas</TabsTrigger>
          </TabsList>

          <TabsContent value="problem" className="space-y-10">
            ...
            <Callout tone="positive" title="GED Customer Validation">
          ...
          <TabsContent value="transform" className="space-y-10">
            <Section
              title="FROM → TO Strategic Transformation"
          ...
          <TabsContent value="consequences" className="space-y-10">
            <Section
            ...
            >
              <LabeledList
                ...
                items={[
                  {
                    label: "1. Inconsistent UX",
                    description:
                      "Different design patterns, auth flows, and IA across each portal. IDS tokens not universally adopted — compounding cognitive load with every cross-tool workflow.",
                  },
                  {
                    label: "2. Duplication of Effort",
                    description:
                      "Search, login, auditing, and notifications are independently rebuilt in each portal. Maintenance overhead compounds at scale as each vertical evolves separately.",
                  },
                  {
                    label: "3. Hindrance to Cross-Domain Innovation",
                    description:
                      "Combining AI Workbench + DDE + IXP in a single workflow has no native integration path. Everything is bespoke, slowing the pace and scope of innovation.",
                  },
                  {
                    label: "4. Inefficient Discovery",
                    description:
                      'No unified search spanning all portals. Developers hunt for APIs, datasets, and tooling across separate systems — "The Treasure Hunt" is step #1 in almost every persona journey.',
                  },
                  {
                    label: "5. No Single Pane of Glass",
                    description:
                      "No consolidated view of projects, metrics, or compliance. Developers toggle between 10+ interfaces for a complete picture. Accountability is fragmented — no single ownership view.",
                  },
                ]}
              />
            </Section>
          ...
          <TabsContent value="systemic" className="space-y-10">
            <Section
          ...
          <TabsContent value="personas" className="space-y-10">
            <Section
              title="Personas & Pain — JTBD-Based"
              description="The original JTBD framework focused primarily on individual contributors. Three additional personas — Product Manager, Engineering Manager, and Technical Leader — are now included."
            >
              <h3 className="text-lg font-medium">Primary personas</h3>
              <div className="grid gap-3">
                {[
                  {
              ...
              <LabeledList
                ...
                items={[
                  ...
                  },
                  {
                    label: "The Steward",
                    description:
                      "Auditing data maturity & compliance.",
                  },
                  {
