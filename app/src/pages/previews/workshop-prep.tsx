    ...
    <PreviewShell platform="Dev Portal" title="Workshop Prep">
      <div className="space-y-12">
        ...
        <Category title="Vision Arc">
            ...
            <div className="grid gap-3">
              {[
                ...
                },
                {
                  ...
                  body: "Platform-as-a-platform doc defines horizontal kernel + vertical workbenches. Delivery Team becomes the ownership unit. March 2025 design research crystallises the core UX principles.",
                },
                {
                  when: "2026 · Now",
          ...
          <Section title="Changed, stayed, shipped, ahead">
        ...
        <Category title="Research Signal">
        ...
        <Category title="Stakeholder Alignment">
              ...
              {[
                {
                  ...
                  voices: "Praneet, Bhavana, April, PDX Design",
                },
                {
            ...
            <div className="grid gap-3">
              {[
                ...
                },
                {
                  ...
                  voices: "Bhavana, Vertical teams, Platform team",
                },
                {
        ...
        <Category title="Future State">
          ...
          <Section title="The core design tension">
            <Callout tone="warning">
              The portal needs to be excellent enough that developers choose
              to use it — while also being invisible enough that developers
              don't need to. These aren't contradictory: the portal is the
              orchestration brain; the IDE and CLI are the hands.
            </Callout>
          </Section>

          <Section title="The design question">
            <Callout>
