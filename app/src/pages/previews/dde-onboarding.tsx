    ...
    <PreviewShell platform="DDE" title="Onboarding">
      <div className="space-y-12">
        ...
        <Tabs defaultValue="overview" className="space-y-8">
                ...
                <CardContent className="p-6">
                  <ul className="space-y-3 text-sm">
                    {[
                      ...
                      [
                        "Data Lake (ADAPT / Iceberg)",
                        "Raw data tables",
                      ],
                      ["DACM / DLAP", "Data access control & management"],
                      [
                        "Databricks",
                        "Interactive compute for exploration",
                      ],
                      [
          ...
          <TabsContent value="mcp" className="space-y-10">
            <Section
            ...
            <Section title="Four MCP servers cover the full data workflow">
              <div className="grid gap-4">
                <Card>
                  ...
                  <CardContent className="space-y-3 text-sm leading-relaxed text-muted-foreground">
                    <p>
                      Search Intuit's entire data catalog using natural
                      language. Find tables by business concept, inspect
                      schemas, explore column metadata and data lineage — all
                ...
                <Card>
                  ...
                  <CardContent className="space-y-3 text-sm leading-relaxed text-muted-foreground">
                    <p>
                      Request, check, and manage access to data tables —
                      directly from your IDE. Interfaces with DACM (Data
                      Access Control Management) and DLAP. Requires Dev Portal
                      service onboarding and a separate INTUIT_API_KEY.
                    </p>
                    <Callout tone="warning">
                      Feature request from users: Currently doesn't return the
                      approver's name. Community has requested this be
                ...
                <Card>
                  ...
                  <CardContent className="text-sm leading-relaxed text-muted-foreground">
                    Run SQL queries, analyze data, and interact with
                    Databricks clusters from your IDE. Pairs with
                    data-discovery-mcp for a complete discover → access →
                    explore workflow. Best used after you have table access
                    confirmed.
                  </CardContent>
                </Card>
          ...
          <TabsContent value="setup" className="space-y-10">
            <Callout title="Fastest path: DAST plugin">
