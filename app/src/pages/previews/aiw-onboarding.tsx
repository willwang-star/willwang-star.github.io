    ...
    <PreviewShell platform="AI Workbench" title="Onboarding">
      <div className="space-y-12">
        ...
        <Category title="Agent Workflow">
          ...
          >
            <h4 data-toc-skip className="text-lg font-medium">
          ...
          <Section title="Why only 26% of GenAI use cases have done evaluations">
          ...
          <Section title="The frontend integration gap">
            <Callout title="GenUX / Intuit Agent Chat">
        ...
        >
          <Section title="The argument against a single IDE">
            <Card>
